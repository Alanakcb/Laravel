...
class MensagemController extends Controller
{
    ...
    */
    ...
    {
        $mensagens = Mensagem::select(['id','mensagem','imagem','created_at','user_id'])
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'topico' => 'array|exists:App\Models\Topico,'
        ]);
        if ($validated){
            try {
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validated){
            try{
                ...
                return $this->error("Error ao atualizar a mensagem!!!", 401, $th->getMessage());
            }
        }
    }
